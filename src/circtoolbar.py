...
class CircToolbar(wx.ToolBar):
    def __init__(self, parent, controller):
        ...
        size = (32,32)
        self.AddLabelTool(ID_ON_SELECT, 'Select', get_bmp(wx.ART_ADD_BOOKMARK, wx.ART_TOOLBAR, size))
        self.AddLabelTool(ID_DEL_SEL_ELEMENTS, 'Delete',get_bmp(wx.ART_DELETE, wx.ART_TOOLBAR, size))
        self.AddLabelTool(ID_RM_LAST, 'Back', get_bmp(wx.ART_UNDO, wx.ART_TOOLBAR, size))
